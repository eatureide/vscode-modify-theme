...
- editor warning color foreground, ref [#24](https://github.com/josefaidt/rouge-theme/issues/24)
- peek view highlight color, set accent highlight
- feat: add marker navigation colors

### Changed

- style: brighter function expression, ref [#26](https://github.com/josefaidt/rouge-theme/issues/26)
- rouge - mute colors, inactive title bar, ref [#18](https://github.com/josefaidt/rouge-theme/issues/18)
